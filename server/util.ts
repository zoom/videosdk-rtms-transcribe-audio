...
// used to generate a JWT for the web app to join the RTMS session
export const generateSignatureForWebApp = (sessionName: string, sdkKey: string, sdkSecret: string): string => {
